...
| `project/map.toon.yaml` | module dependency map | `markpact:file` |
...
The `project/` directory is generated by running `sumd analyze` (which invokes `code2llm`, `redup`, `vallm`).
